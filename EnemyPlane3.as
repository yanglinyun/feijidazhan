    ...
    public class EnemyPlane3 extends EnemyPlane {
        ...
        private function fireThreeBullet(bulletComb:Array) {
            ...
            for (var i:int = 0; i < bulletArr.length; i++) {
                ...
                if (_mustCombArr.length == 0 && threeBulletArr[0].degree == 5 && threeBulletArr[1].degree == 5.5 && threeBulletArr[2].degree == 6 && threeBulletArr[3].degree == 6.5 && threeBulletArr[4].degree == 7) {
